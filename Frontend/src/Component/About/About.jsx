    ...
    <div className="main-container">
      <div className="container-for-content">
        ...
        <ScrollAnimation animateIn="animate__fadeInUp" animateOnce>
          <h3>ABOUT US</h3>
          <p>
            Welcome to Aqua Market, your trusted online destination for
            purchasing a wide variety of ornamental fish. We bring the beauty of
            aquatic life right to your doorstep, ensuring a seamless and
            enjoyable experience for all fish enthusiasts. At Aqua Market, we
            are passionate about offering high-quality ornamental fish from
