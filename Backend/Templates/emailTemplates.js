                ...
                <td class="main-content">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          You are just one step away to Reset your password for this account: <span style="color: #4C83EE;">{{email}}</span>.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px; font-size: 14px; line-height: 150%; font-weight: 700;">
                          Use below OTP for reset your password.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 24px;">
...
`
export{EMAIL_VERIFY_TEMPLATE,EMAIL_VERIFY_TEMPLATE_2,LOGIN_EMAIL_TEMPLATE}